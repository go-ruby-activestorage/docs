...
The public API lives at the module root (`github.com/go-ruby-activestorage/activestorage`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `activestorage`, while the surface follows
...
```go
import "github.com/go-ruby-activestorage/activestorage"
```
...
- **[pkg.go.dev/github.com/go-ruby-activestorage/activestorage](https://pkg.go.dev/github.com/go-ruby-activestorage/activestorage)**

The module's [README](https://github.com/go-ruby-activestorage/activestorage#readme) carries worked
