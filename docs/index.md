# go-ruby-activestorage documentation

**Pure-Go, MRI-4.0.5-faithful Ruby activestorage (no cgo)**

`go-ruby-activestorage/activestorage` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `activestorage`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-activestorage/activestorage`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `activestorage`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`activestorage`](https://github.com/go-ruby-activestorage/activestorage) | the library — Ruby's `activestorage` in pure Go |
| [`docs`](https://github.com/go-ruby-activestorage/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-activestorage.github.io`](https://github.com/go-ruby-activestorage/go-ruby-activestorage.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-activestorage/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-activestorage/activestorage](https://github.com/go-ruby-activestorage/activestorage).
